#' COPUS codes from: Anatomy of STEM teaching in North American higher-ed
#'
...
stains2018_codes <- function() {
  ...
  stains2018.code <-
    read_excel(paste0(getwd(), '/stains2018_dataset.xlsx'), sheet = 2)
  stains2018.code <- stains2018.code %>%
    fill(Category)
  stains2018.code
}
